...
{
	// limpa os registros, zerando os bits
	...
	// veriufica se o arquivo é do tipo wave
	DWORD filetype;
	...
	buffer.pAudioData = pDataBuffer;		// os dados (bits) de audio
	buffer.Flags = XAUDIO2_END_OF_STREAM;	// fim do buffer para a "Source Voice"
