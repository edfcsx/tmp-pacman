...
//				derivada de Game e sobrescrever os métodos Init, Update
//				Draw e Finalize. Para rodar o jogo, deve-se passar o
//				objeto Game para o método Start() de um objeto Engine.
//
*******************************************************************************/
...
protected:
	// Window*& isso é uma referência para um ponteiro
