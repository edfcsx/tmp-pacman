/*******************************************************************************
	...
	Descrição:	Essa é a classe base para todos objetos do jogo.
				...
				Um objeto do jogo é qualquer coisa que possámos querer
				desenhar ou interagir dentro do jogo. Por exemplo, um soldado,
				um prédio, um projétil, uma forma geométrica, etc.
*******************************************************************************/
...
#include "Types.h"					// usando tipos personalizados da engine
...
// retorna typo do objeto
inline uint Object::Type() const
{
	return type;
}

// retona a bounding box do objeto
inline Geometry* Object::BBox() const
{ return bbox; }
 
// -----------------------------------------------------------------------------

#endif // !_PROGJOGOS_OBJECT_H_
