/*******************************************************************************
	...
	Descrição:	Graphics é uma classe que faz uso das funções
				do Direct3D para acessar o hardware de aceleração gráfica da
				placa de vídeo.
*******************************************************************************/
...
bool Graphics::Initialize(Window* window)
{
	...
	// Ajusta a cor de fundo do backbuffer para a mesma cor de fundo da janela
	...
	swapDesc.BufferUsage = DXGI_USAGE_RENDER_TARGET_OUTPUT;			// utilize superfície como RENDET-TARGET
	...
	swapDesc.Flags = DXGI_SWAP_CHAIN_FLAG_ALLOW_MODE_SWITCH;		// muda a resolução do monitor em tela
	...
	// liga uma render-target ao estágio output-merge
	...
	// liga a viewport ao estagio de rasterização
	...
	*/
	...
	blendDesc.RenderTarget[0].SrcBlendAlpha = D3D11_BLEND_ONE;			// fonte de mistura Alpha é o alpha do pixel shader
