...
private:
	...
	uint columns;								// números de colunas na folha
...
public:
	...
	// esse construtor foi criado para a utilização de fontes
	TileSet(string filename,					// nome do arquivo
			uint numLines,						// número de linhas
			uint numCols);						// número de colunas
	...
	uint	Columns();							// retorna número de colunas na folha
